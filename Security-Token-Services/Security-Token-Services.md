...
jobs:
 ...
 Requires long-term AWS credentials to be stored in GitHub Secrets 
...
⸻
 ...
 Real MFA codes expire quickly; use only for local testing or rotate dynamically.
...
phases:
 ...
 #  Replace with real-time input for actual use
